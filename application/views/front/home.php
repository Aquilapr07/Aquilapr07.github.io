<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <h3 class="display-2">Cafe DOYAN MANGAN</h3>
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption text-right">
                <h1 class="display-2">Cafe terbaik dan ternyaman!</h1>
                <h3>kami di sini untuk melayani Anda</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">order sekarang</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">View Menu</a>
            </div>
...
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Pilih Cafe</h3>
            <p>Hal pertama yang dapat Anda lakukan adalah memilih dari mitra cafe kami dengan mudah!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <i class="fas fa-bullseye"></i>
            <h3>Pilih hidangan lezat</h3>
            <p>Kami membantu Anda dengan menu dari berbagai cafe pengiriman online!</p>
        </div>
